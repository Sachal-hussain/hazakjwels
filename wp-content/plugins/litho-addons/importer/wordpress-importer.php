...
function wordpress_importer_init() {
	load_plugin_textdomain( 'litho-addons' );
	...
	register_importer( 'wordpress', 'WordPress', __( 'Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'litho-addons' ), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
