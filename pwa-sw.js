const CACHE_VERSION = '1.7.75';

const BASE_CACHE_FILES = [
    'http://localhost/jwelery/wp-content/plugins/pwa-for-wp/images/logo.png',
'',
'http://localhost/jwelery/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'',
'http://localhost/jwelery/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
...
const OFFLINE_PAGE = 'http://localhost/jwelery/';
const NOT_FOUND_PAGE = 'http://localhost/jwelery/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('http://localhost/jwelery//wp-admin/');
//    },
];
